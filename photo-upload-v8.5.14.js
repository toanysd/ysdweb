...
(function (global) {
  ...
  var TMPL_MAIN = [
    ...
    '      <div class="pu-spinner" style="margin: 0 auto 20px auto; width:40px; height:40px; border-width:4px; border-top-color:#10b981;"></div>',
    '      <div class="pu-confirm-title" style="margin-bottom:8px; font-size:18px; color:#1f2937;">Sẵn sàng Máy ảnh...</div>',
               ...
               if (video && video.readyState >= 2 && video.videoWidth > 0) {
                 ...
                 try {
                   ...
                   c.toBlob(function(b){
                      ...
                      cleanup();
                      /* Bypass & Call back camera immediately */
                      setTimeout(function() { if (fileInputCamera) fileInputCamera.click(); }, 100);
                   }, 'image/jpeg', 0.9);
                 } catch(e) { 
                   cleanup(); 
                   if (fileInputCamera) fileInputCamera.click();
