      ...
      this.panel.innerHTML = `
        ...
        <div class=\"dp-mobile-actionbar\" data-dp-mobile-actionbar=\"1\">
          <div class=\"dp-actions-grid\">
            <button class=\"dp-action-btn\" data-action=\"inout\" type=\"button\" title=\"Nhập / Xuất\">
              <i class=\"fas fa-right-left\"></i>
              <span>In/Out</span>
              <span class=\"sub\">Nhập / Xuất</span>
            </button>
            <button class=\"dp-action-btn\" data-action=\"move\" type=\"button\" title=\"Di chuyển\">
              <i class=\"fas fa-map-signs\"></i>
              <span>Move</span>
              <span class=\"sub\">Di chuyển</span>
            </button>
    ...
    renderDesktopQuickActions(item, type) {
      return `
        <div class="modal-section">
          ...
          <div class="dp-actions-grid">
            <button class="dp-action-btn" data-action="inout" type="button">
              <i class="fas fa-right-left"></i>
              <span>入出庫<br><span class="sub">Nhập / Xuất</span></span>
            </button>
      ...
      return `
        <div class="modal-section location-section">
          ...
          <div class="location-content">
            ...
            ` : `
            <div class="dp-storage-mobile-grid" style="display:grid;grid-template-columns:${this.isDesktopWide ? 'minmax(140px,44vw) minmax(0,1fr)' : '3fr 7fr'};gap:10px;align-items:stretch">
              <div style="position:relative;border-radius:12px;overflow:hidden;border:1px solid rgba(15,23,42,0.10);background:#fff;min-height:160px">
                <img data-dp-thumb-img="1"
                     src=""
                     alt=""
