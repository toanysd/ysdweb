...
(function (global) {
  ...
  var TMPL_MAIN = [
    ...
    '  <button class="pu-btn" id="puSendNewBtn" style="flex: 1; padding: 10px 6px; font-size: 11px; font-weight: 700; color: #fff; background: #3b82f6; border-radius: 8px; border: none; min-width: 80px;">',
    '    <i class="fas fa-paper-plane"></i> Gửi & Tiếp',
    '  </button>',
    '  <button class="pu-btn" id="puSendCloseBtn" style="flex: 1; padding: 10px 6px; font-size: 11px; font-weight: 700; color: #fff; background: #10b981; border-radius: 8px; border: none; min-width: 80px;">',
    '    <i class="fas fa-check-circle"></i> Gửi & Đóng',
    '  </button>',
    '  <button class="pu-btn" id="puSendQuickBtn" style="flex: 1; padding: 10px 6px; font-size: 11px; font-weight: 700; color: #b45309; background: #fef3c7; border-radius: 8px; border: 1px solid #fcd34d; min-width: 90px;">',
    '    <i class="fas fa-bolt"></i> Gửi Nhanh',
    '  </button>',
    '  <button class="pu-btn" id="puCancelBtn" style="flex: 0 0 60px; padding: 10px 6px; font-size: 11px; font-weight: 700; color: #4b5563; background: #f3f4f6; border-radius: 8px; border: 1px solid #d1d5db;">',
    '    Đóng',
    '  </button>',
    '</div>',
