  ...
  function _renderMasterTable() {
    ...
    el.innerHTML = \`<table class="pm-table">
      ...
      <tbody>\${all.map(m => \`<tr>
        ...
        <td><button class="pm-btn-xs" data-action="edit-master" data-id="\${m.plastic_id}">✏️</button></td>
      </tr>\`).join('')}</tbody>
    </table>\`;
  }
...
fs.writeFileSync('plastic/plastic-master-ui.js', code, 'utf8');
console.log('Rewritten plastic-master-ui.js');
