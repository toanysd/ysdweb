...
(function(){
  ...
  const STORAGE_KEY = 'dp_assistive_touch__v8.4.3-2';
  ...
  function ensureMinimalStyles(){
    ...
    st.textContent = `
      ...
      /* JP|VI label inside action button (fallback) */
      detailPanel .dp-action-btn .dp-label-jp{ display:block; font-weight:950; font-size:11px; line-height:1.05; }
      detailPanel .dp-action-btn .dp-label-vi{ display:block; font-weight:900; font-size:10px; opacity:0.78; line-height:1.05; }
      ...
      /* Assistive menu position will be set by JS; ensure it can be moved */
