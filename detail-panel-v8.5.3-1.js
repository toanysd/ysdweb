      ...
      this.panel.innerHTML = `
        ...
        <div class=\"dp-mobile-actionbar\" data-dp-mobile-actionbar=\"1\">
          <div class=\"dp-actions-grid\">
            <button class=\"dp-action-btn\" data-action=\"inout\" type=\"button\" title=\"入出庫・位置変更 / Nhập xuất, thay đổi vị trí\">
              <i class=\"fas fa-map-marker-alt\"></i>
              <span class=\"dp-action-label-ja\">入出庫・位置変更</span>
              <span class=\"sub dp-action-label-vi\">Nhập xuất, Vị trí</span>
            </button>


            <button class=\"dp-action-btn\" data-action=\"inventory\" type=\"button\" title=\"Kiểm kê\">
              <i class=\"fas fa-clipboard-check\"></i>
              <span>Audit</span>
              <span class=\"sub\">Kiểm kê</span>
            </button>
            <button class=\"dp-action-btn\" data-action=\"qr\" type=\"button\" title=\"QR\">
              <i class=\"fas fa-qrcode\"></i>
              <span>QR</span>
              <span class=\"sub\">Mã</span>
            </button>
            <button class=\"dp-action-btn\" data-action=\"photo\" type=\"button\" title=\"Ảnh\">
              <i class=\"fas fa-camera\"></i>
              <span>Photo</span>
              <span class=\"sub\">Ảnh</span>
            </button>
          </div>
        </div>
  ...
  try {
      ...
      if (String(action).toLowerCase().trim() === 'inout') {
        try {
          if (window.CheckInOut && typeof window.CheckInOut.openModal === 'function') {
            // Mở modal ở mode check-in, trong modal có nút chuyển sang check-out
      ...
      return `
        <div class="modal-section">
          ...
          <div class="dp-actions-grid">
            ...
            <button class="dp-action-btn" data-action="inventory" type="button">
              <i class="fas fa-clipboard-check"></i>
              <span>棚卸</span>
              <span class="sub">Kiểm kê</span>
            </button>
            <button class="dp-action-btn" data-action="print" type="button">
              <i class="fas fa-print"></i>
              <span>印刷</span>
              <span class="sub">In</span>
            </button>
            <button class="dp-action-btn" data-action="qr" type="button">
              <i class="fas fa-qrcode"></i>
              <span>QR</span>
              <span class="sub">Mã</span>
            </button>
            <button class="dp-action-btn" data-action="photo" type="button">
              <i class="fas fa-camera"></i>
              <span>写真</span>
              <span class="sub">Ảnh</span>
            </button>
    ...
    renderDesktopQuickQueries(mold) {
      ...
      return `
        <div class="modal-section">
          ...
          <div class="dp-actions-grid" >
            <button class="dp-action-btn" type="button" data-jump="history"><i class="fas fa-history"></i><span>履歴</span><span class="sub">Lịch sử</span></button>
            <button class="dp-action-btn" type="button" data-jump="teflon"><i class="fas fa-spray-can"></i><span>Teflon</span><span class="sub">Coating</span></button>
            <button class="dp-action-btn" type="button" data-jump="storage"><i class="fas fa-warehouse"></i><span>Storage</span><span class="sub">Kho</span></button>
            <button class="dp-action-btn" type="button" data-jump="transfer"><i class="fas fa-truck"></i><span>Transfer</span><span class="sub">Vận chuyển</span></button>
            <button class="dp-action-btn" type="button" data-jump="extended"><i class="fas fa-layer-group"></i><span>Extended</span><span class="sub">Mở rộng</span></button>
            <button class="dp-action-btn" type="button" data-action="print"><i class="fas fa-print"></i><span>印刷</span><span class="sub">In</span></button>
          </div>
        </div>
      `;
    }
    ...
    renderMoldBasicInfoFull(item) {
      ...
      return `<div class="modal-section">
        ...
        ${this.renderInfoGrid(fields, "dp-info-rows dp-keep-2col dp-kv-maininfo dp-kv-group-basic")}
      </div>`;
    }
    ...
    renderCutterBasicInfoFull(item) {
      ...
      return `<div class="modal-section">
        ...
        ${this.renderInfoGrid(fields, 'dp-info-rows dp-keep-2col dp-kv-maininfo')}
      </div>`;
    }
    ...
    renderMoldProductJobSection(mold, design, job) {
      ...
      return `
        <div class="modal-section">
          ...
          ${this.renderInfoGrid(prodFields, "dp-info-rows dp-kv-group-product")}
        </div>
      `;
    }
    ...
    renderCutterTechnicalInfoFull(item) {
      ...
      return `
        <div class="modal-section">
          ...
          <div class="info-grid-2col dp-kv-group-technical">
            <div class="info-item">
    ...
    renderCutterProductReferenceSection(cutter) {
      ...
      return `
        <div class="modal-section">
          ...
          <div class="info-grid-2col dp-kv-group-product" >
            <div class="info-item">
