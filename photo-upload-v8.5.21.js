...
(function (global) {
  ...
  var TMPL_MAIN = [
    ...
    '  <div class="pu-confirm-overlay pu-hidden" id="puActionSheetOverlay" style="align-items:flex-end; padding:0; background:rgba(0,0,0,0.5); z-index:2147483605;">',
    ...
    '  <div class="pu-confirm-overlay pu-hidden" id="puSecurityOverlay" style="background:rgba(255,255,255,0.7); z-index:2147483605; align-items:flex-start; padding-top:70px;">',
