/* ============================================================================
   quick-update-module-v8.5.3-3.js
   Module cập nhật nhanh (Wizard Flow) - Version 3
   - Hỗ trợ: Các bước (Steps), Shiplog, Background save.
   - Fix: Đồng bộ UI bằng cách ghi datachangehistory.csv (Audit Log).
   ============================================================================ */

(function(global) {
    'use strict';

    var VERSION = 'v8.5.3-3';
            ...
            try {
                ...
                for (var key in this.wizardState.fields) {
                    ...
                    if (newVal !== oldVal) {
                        ...
                        // 2. Ghi datachangehistory.csv (Dùng cho cả hiển thị priority và lưu EmployeeID)
                        var historyRow = {
                            ...
                            ChangeSource: 'quick_update_v3',
                            ChangeNote: 'Wizard Update',
                            IsConflict: 'FALSE'
                        };
                ...
                this.notify('Đã lưu thành công và cập nhật Audit Log!', 'success');
                
                // Mấu chốt: loadAllData để tải lại History và web*.csv mới
